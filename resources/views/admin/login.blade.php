...
<head>
     <meta charset="utf-8" />
    <title>Ganpati Society Admin</title> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta
    content="Ganpati Society Admin" name="description" />
<!-- App favicon -->
    ...
    <!-- Bootstrap Css -->
<link href="{{ config('app.url') }}assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" /> <!-- Icons Css -->
...
<!-- App Css-->
    ...
    <!-- custom Css-->
<link href="{{ config('app.url') }}assets/css/custom.min.css" rel="stylesheet" type="text/css" /> </head>
...
<body> 
    ...
    <div class="auth-one-bg-position auth-one-bg" id="auth-particles">
        ...
        <div class="shape">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0
            1440 120">
                ...
                <div class="card-body p-4">
                    <div class="text-center mt-2">
                        <a href="{{ config('app.url') }}" class="d-inline-block auth-logo">
                            <img src="{{ config('app.url') }}assets/images/logo-new.png" alt="" style="max-height: 77px;">
                        </a>
